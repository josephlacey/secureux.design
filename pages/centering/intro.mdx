...
#### TABLE: Universal Declaration of Human Rights

```
[UDHR](https://www.ohchr.org/EN/UDHR/Documents/UDHR_Translations/eng.pdf) is a declaration that spells out basic rights that all human rights should enjoy. It is not an international treaty; it is a statement/declaration that lays out potential for rights. Thus, it is often called soft law which means it is not legally enforceable in court.
