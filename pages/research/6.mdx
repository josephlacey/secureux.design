...
>
>The goal of this exercise is to compare an ideal scenario in your community to the reality and frictions that you’ve found within your >research. However, we need to heavily caveat this section. In a non-HRCD process, use cases are often oversimplified and reflect 
>real-world stereotypes. To avoid creating shallow use cases, use your deep research to build out more accurate ones. Let’s use the Human
>Rights Watch example from the text. 
>
